...
Det viser seg at de r\o{}ttene med synkope opprinnelig var r\o{}tter p\aa{}
\w{--r} som fulgte det vanlige m\o{}nsteret, men i nominativsformen
f\o{}lgende skjedd: \w{--ros} > \w{--rs} > \w{--rr} > \w{--\r{r}} > \w{--er}.
Vokalen i nominativsendelsen (som opprinnelig var \w{o}) falt fort foran
\w{r}, \w{s} ble s\aa{} assimilert til \w{r}, dobbel \w{r} ble trukket sammen
til syllabisk \w{\r{r}} som s\aa{} ble til \w{er}. Men denne endringen tok
ikke sted i r\o{}tter der \w{--r} kom fra en \w{s} som var blitt stemt mellom
vokaler, som for eksempel \w{numerus}, og vi ser hvordan disse formene har
blitt leksikalisert. \cite{ernout}
